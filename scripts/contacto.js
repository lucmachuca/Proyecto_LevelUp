...
function validarFormulario() {
    ...
    if (email.value && !validarEmail(email.value)) {
        ...
        email.classList.add('is-invalid');
        document.getElementById('email-error').textContent = 'Máximo 100 caracteres';
        isValid = false;
    }
    ...
    if (!comentario.value.trim()) {
        ...
        document.getElementById('comentario-error').textContent = 'Por favor ingresa tu mensaje';
        isValid = false;
    } else if (comentario.value.length > 500) {
        comentario.classList.add('is-invalid');
        document.getElementById('comentario-error').textContent = 'Máximo 500 caracteres';
        isValid = false;
    }
