const productos = [
  {
    ...
    precio: 599990,
    imagen:
      "https://clsonyb2c.vtexassets.com/arquivos/ids/465172-1600-auto?v=638658958190900000&width=1600&height=auto&aspect=true",
    imagenes: [
    ...
    categoria: "Consolas",
    descripcion:
      "Consola de última generación con gráficos 4K y SSD ultrárápido. Experimenta velocidades de carga increíblemente rápidas con un SSD de ultra alta velocidad.",
    stock: 15,
    especificaciones: {
      marca: "Sony",
  ...
  },
  {
    ...
    precio: 89990,
    imagen:
      "https://media.falabella.com/falabellaCL/116586411_01/w=1500,h=1500,fit=pad",
    imagenes: [
  ...
  },
  {
    ...
    categoria: "Juegos",
    descripcion:
      "El mejor fútbol en tu consola. Modo carrera mejorado, gráficos hyper-realistas con todos los estadios y ligas oficiales.",
    stock: 0,
    especificaciones: {
      marca: "EA Sports",
  ...
  },
  {
    ...
    precio: 59990,
    imagen:
      "https://juegosdigitaleschile.com/files/images/productos/1718041978-call-of-duty-black-ops-6-ps4-pre-orden-0.webp",
    imagenes: [
...
function mostrarProductos(productosArray = productos) {
  ...
  setTimeout(() => {
    ...
    // Actualizar contador
    productCount.textContent = `${productosArray.length} producto${
      productosArray.length !== 1 ? "s" : ""
    } encontrado${productosArray.length !== 1 ? "s" : ""}`;
    ...
    productosArray.forEach((producto) => {
      ...
      col.innerHTML = `
        ...
        producto.nombre
                    ...
                    <p class="price">$${producto.precio.toLocaleString(
                      "es-CL"
                    )}</p>
                    <div class="d-flex gap-2">
                        ...
                        <button class="btn btn-outline-neon" onclick="verDetalleProducto(${
                          producto.id
                        })">
