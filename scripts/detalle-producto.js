...
const productos = [
    {
        ...
        categoria: "Consolas",
        descripcion: "Consola de última generación con gráficos 4K y SSD ultrarrápido. Experimenta velocidades de carga increíblemente rápidas con un SSD de ultra alta velocidad.",
        stock: 15,
        especificaciones: {
            marca: "Sony",
    ...
    },
    {
        ...
        precio: 399990,
        imagen: "https://media.falabella.com/falabellaCL/123426297_01/w=1500,h=1500,fit=pad",
        imagenes: [
    ...
    },
    {
        ...
        precio: 89990,
        imagen: "https://media.falabella.com/falabellaCL/116586411_05/w=1500,h=1500,fit=pad",
        imagenes: [
    ...
    },
    {
        ...
        categoria: "Juegos",
        descripcion: "El mejor fútbol en tu consola. Modo carrera mejorado, gráficos hyper-realistas y todos los estadios y ligas oficiales.",
        stock: 0,
        especificaciones: {
            marca: "EA Sports",
    ...
    },
    {
        ...
        precio: 59990,
        imagen: "https://clsonyb2c.vtexassets.com/arquivos/ids/464506-1600-auto?v=638587175232800000&width=1600&height=auto&aspect=true",
        imagenes: [
...
function mostrarProducto(producto) {
    ...
    if (producto.stock > 0) {
        ...
        warningElement.innerHTML = '<i class="bi bi-exclamation-triangle"></i> Producto temporalmente agotado';
...
function cargarProductosRelacionados(categoria, productIdExclude) {
    ...
    const productosRelacionados = productos.filter(p => 
        p.categoria === categoria && p.id !== productIdExclude
    ).slice(0, 4);
    
    if (productosRelacionados.length === 0) {
        relatedContainer.innerHTML = '<p class="text-center">No hay productos relacionados</p>';
        return;
    }
    ...
    productosRelacionados.forEach(producto => {
        ...
        col.innerHTML = `
            <div class="product-card" data-id="${producto.id}">
                ...
                <button class="btn btn-view" onclick="verProducto(${producto.id})">
...
function manejarCantidad() {
    ...
    quantityInput.addEventListener('change', (e) => {
        ...
        if (newValue > (productoActual?.stock || 10)) newValue = productoActual.stock;
        cantidad = newValue;
        quantityInput.value = cantidad;
    });
}
    ...
    addButton.addEventListener('click', () => {
        ...
        if (productoExistente) {
            ...
            if (nuevaCantidad > productoActual.stock) {
                mostrarMensaje(`No hay suficiente stock. Máximo disponible: ${productoActual.stock}`, 'error');
                return;
            }
