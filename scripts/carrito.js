...
const productos = [
    {
        ...
        precio: 599990,
        imagen: "https://images.unsplash.com/photo-1606813907291-d86efa9b94db?ixlib=rb-4.0.3&w=400",
        categoria: "Consolas"
    },
    {
        id: 2,
        ...
        precio: 549990,
        imagen: "https://images.unsplash.com/photo-1621259182978-fbf93132d53d?ixlib=rb-4.0.3&w=400",
        categoria: "Consolas"
    },
    {
        id: 3,
    ...
    },
    {
        ...
        precio: 89990,
        imagen: "https://images.unsplash.com/photo-1541140532154-b024d705b90a?ixlib=rb-4.0.3&w=400",
    ...
    },
    {
        ...
        nombre: "Mouse Gaming",
        precio: 49990,
        imagen: "https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?ixlib=rb-4.0.3&w=400",
        categoria: "Accesorios"
    },
    {
        id: 6,
        ...
        precio: 79990,
        imagen: "https://images.unsplash.com/photo-1599660646820-4cdfe6d531f6?ixlib=rb-4.0.3&w=400",
        categoria: "Accesorios"
    },
    {
        id: 7,
        ...
        precio: 299990,
        imagen: "https://images.unsplash.com/photo-1643019535780-e4c5f26a8f28?ixlib=rb-4.0.3&w=400",
        categoria: "Accesorios"
    },
    {
        id: 8,
        ...
        precio: 49990,
        imagen: "https://images.unsplash.com/photo-1614294149710-32eec425a251?ixlib=rb-4.0.3&w=400",
        categoria: "Juegos"
    },
    {
        id: 9,
        ...
        precio: 59990,
        imagen: "https://images.unsplash.com/photo-1542751371-adc38448a05e?ixlib=rb-4.0.3&w=400",
        categoria: "Juegos"
    },
    {
        id: 10,
        ...
        precio: 199990,
        imagen: "https://images.unsplash.com/photo-1598301257982-0cf01499abb2?ixlib=rb-4.0.3&w=400",
        categoria: "Accesorios"
    },
    {
        id: 11,
        ...
        precio: 29990,
        imagen: "https://images.unsplash.com/photo-1596461404969-9ae70f2830c1?ixlib=rb-4.0.3&w=400",
        categoria: "Accesorios"
    },
    {
        id: 12,
        ...
        precio: 89990,
        imagen: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&w=400",
        categoria: "Accesorios"
    }
];
        ...
        if (producto) {
            ...
            itemElement.innerHTML = `
                ...
                <div class="cart-item-info">
                    ...
                    <p class="cart-item-price">$${(producto.precio * item.cantidad).toLocaleString('es-CL')}</p>
                    <div class="cart-item-controls">
                        <div class="quantity-controls">
                            <button class="quantity-btn" onclick="cambiarCantidad(${item.id}, -1)">-</button>
                            <input type="number" value="${item.cantidad}" min="1" class="quantity-input" 
